...
diablo_ii_archipelago_location = {}
diablo_ii_archipelago_location.__index = diablo_ii_archipelago_location
...
function diablo_ii_archipelago_location.new(name)
    local self = setmetatable({}, diablo_ii_archipelago_location)
    if name then
...
function diablo_ii_archipelago_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = diablo_ii_archipelago_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
function diablo_ii_archipelago_location:connect_two_ways(exit, rule)
...
function diablo_ii_archipelago_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function diablo_ii_archipelago_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function diablo_ii_archipelago_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function diablo_ii_archipelago_location:connect_two_ways_stuck(exit, rule1, rule2)
...
function diablo_ii_archipelago_location:accessibility()
...
-- 
function diablo_ii_archipelago_location:discover(accessibility, keys)
...
entry_point = diablo_ii_archipelago_location.new("entry_point")
